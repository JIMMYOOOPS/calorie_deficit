...
type DailyIntakeUpdateRequestDTO struct {
	...
	MealItems []MealItemResponseDTO `json:"meal_items" binding:"required,dive"` // MealItems is a slice of MealItem
}

type DailyIntakeUpdateServiceDTO struct {
	MealItems []MealItemResponseDTO `json:"mealItems"` // MealItems is a slice of MealItem
}
